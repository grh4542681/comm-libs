...
#define MODEL_LOG_FORMAT_DEFAULT LOG_FORMAT_DEFAULT
...
private:
    Log() : log::Interface() {
        ...
        rule_map_.clear();
        rule_map_.insert({
            {log::Priority::Emergency, MODEL_LOG_FORMAT_DEFAULT},
            {log::Priority::Alert,     MODEL_LOG_FORMAT_DEFAULT},
            {log::Priority::Critical,  MODEL_LOG_FORMAT_DEFAULT},
            {log::Priority::Error,     MODEL_LOG_FORMAT_DEFAULT},
            {log::Priority::Warning,   MODEL_LOG_FORMAT_DEFAULT},
            {log::Priority::Notice,    MODEL_LOG_FORMAT_DEFAULT},
            {log::Priority::Info,      MODEL_LOG_FORMAT_DEFAULT},
            {log::Priority::Debug,     MODEL_LOG_FORMAT_DEFAULT},
            {log::Priority::Debug2,    MODEL_LOG_FORMAT_DEFAULT},
            {log::Priority::Debug3,    MODEL_LOG_FORMAT_DEFAULT},
        });
    }
};
