...
if (${libsignal_FOUND})
    ...
    list(APPEND DEPEND_INC_DIR "${DEPEND_LIBSIGNAL_INSTALL_DIR}/include")
    list(APPEND DEPEND_LIB_DIR "${DEPEND_LIBSIGNAL_INSTALL_DIR}/lib")
else ()
    message("libsignal begin building...")
