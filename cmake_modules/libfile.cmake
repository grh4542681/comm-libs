...
if (${libfile_FOUND})
    ...
    list(APPEND DEPEND_INCLUDE_DIR "${DEPEND_LIBFILE_INSTALL_DIR}/include")
    list(APPEND DEPEND_LIB_DIR "${DEPEND_LIBFILE_INSTALL_DIR}/lib")
else ()
    include(ExternalProject)
    set(DEPEND_LIBFILE_CMAKE_ARGS)
    list(APPEND DEPEND_LIBFILE_CMAKE_ARGS "-DBUILD_UT=OFF")
    ...
    list(APPEND DEPEND_LIBFILE_CMAKE_ARGS "-DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS}")
    list(APPEND DEPEND_LIBFILE_CMAKE_ARGS "-DBUILD_DEPEND_LIBS=ON")
