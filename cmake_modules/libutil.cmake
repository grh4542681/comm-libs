...
if (${libutil_FOUND})
    ...
    list(APPEND DEPEND_INCLUDE_DIR "${DEPEND_LIBUTIL_INSTALL_DIR}/include")
    list(APPEND DEPEND_LIB_DIR "${DEPEND_LIBUTIL_INSTALL_DIR}/lib")
else ()
    include(ExternalProject)
    set(DEPEND_LIBUTIL_CMAKE_ARGS)
    list(APPEND DEPEND_LIBUTIL_CMAKE_ARGS "-DBUILD_UT=OFF")
    list(APPEND DEPEND_LIBUTIL_CMAKE_ARGS "-DBUILD_STATIC_LIBS=${BUILD_STATIC_LIBS}")
    list(APPEND DEPEND_LIBUTIL_CMAKE_ARGS "-DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS}")
